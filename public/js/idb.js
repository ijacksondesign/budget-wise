...
request.onupgradedneeded = function(event) {
    ...
    // creates an object store (like a table) and calls it 'new_transaction.' This table is then given an autoincremeting primary key
    db.createObjectStore('new_transaction', { autoIncrement: true });
};

// runs after connection to database is finalized
request.onsuccess = function(event) {
    // when object store is created from the 'onupgradedneeded' event, this saves a reference to the global db variable
